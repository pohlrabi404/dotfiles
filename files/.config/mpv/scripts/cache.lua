...
function streamcache_compute_cache_sizes()
    ...
    mp.msg.log("debug",
        ...
        " vb=" ..
        vb ..
        " br=" .. br .. " kb_per_sec=" .. kb_per_sec .. " streamcache_last_kb_per_sec=" .. streamcache_last_kb_per_sec)
    ...
    if ((rate_change < 0.9) or (rate_change > 1.1)) then
        ...
        mp.msg.log("v",
            "bitrate changed from " ..
            streamcache_last_kb_per_sec ..
            " kB/s to " .. kb_per_sec .. " kB/s, streamcache_cache_high now " .. streamcache_cache_high .. " kB")
